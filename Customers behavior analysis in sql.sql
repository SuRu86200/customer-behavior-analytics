...
select shipping_type, round(avg(purchase_amount),2) as average_purchased_amount from customers
where shipping_type in ('Standard','Express')
group by shipping_type;

-- Q5. Do subscribed customers spend more? Compare average spend and total 
-- revenue between subscribers and non-subscibers.
...
-- Q8. What are tope 3 most purchased products within each category?
WITH item_count AS (
    SELECT 
        category, 
        item_purchased,
        COUNT(customer_id) AS total_orders, -- Fixed typo: customer_id
...
FROM item_count
WHERE item_rank <= 3  -- This gives you the Top 3 per category
